...
public class Menu extends javax.swing.JPanel {
    ...
    public void initMenuItem() {
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/1.png")), "Dashboard", "Home", "Admissions"));
        ...
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/3.png")), "Curriculum Management", "Flowchart", "Academic Calendar", "Programs", "Courses"));
    }
